...
def train_logreg(data_path: str, target_column: str, output_dir: str, eval_path: str | None = None) -> None:
    ...
    with (output_path / "logreg_metrics.json").open("w", encoding="utf-8") as handle:
...
if __name__ == "__main__":
    args = parse_args()
    train_logreg(args.data, args.target, args.output_dir, eval_path=args.eval_data)
